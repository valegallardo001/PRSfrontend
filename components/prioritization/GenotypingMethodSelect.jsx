// components/prioritization/GenotypingMethodSelect.jsx
"use client";

import { Select, SelectItem } from "@heroui/react";

const methods = ["WGS", "WES", "SNP array"];

export default function GenotypingMethodSelect({ value, onChange }) {
    return (
        <div>
            <Select
